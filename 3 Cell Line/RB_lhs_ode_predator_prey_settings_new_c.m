...
ode.parameters = ...
{
        { 'aKill_N', 'lu', 1e-8, 2e-7} ...
        { 'aKill_P', 'lu', 1e-7, 5e-7} ...
        { 'aKill_L', 'lu', 1e-7, 3e-6} ...
        { 'aKill_D', 'lu', 1e-7, 1e-6} ...
        };
...
%
% Comments lines must be preceded by "...".
BATs_numbers_MCF7=table2array(readtable('BATs_numbers_C.xlsx','Sheet','MCF7','VariableNamingRule','preserve'));
BATs_numbers_CAMA1=table2array(readtable('BATs_numbers_C.xlsx','Sheet','CAMA1','VariableNamingRule','preserve'));
BATs_numbers_T47D=table2array(readtable('BATs_numbers_C.xlsx','Sheet','T47D','VariableNamingRule','preserve'));

ode.initialConditions = ...
{
    { 'MCF7', '',  1,1} ... (Tumor cells)
    { 'M_NBATs', '',  BATs_numbers_MCF7(1,2),  BATs_numbers_MCF7(1,2)} ... (BATs)
    { 'M_LBATs', '',  BATs_numbers_MCF7(1,4),  BATs_numbers_MCF7(1,4)} ... (BATs)
    { 'M_PBATs', '',  BATs_numbers_MCF7(1,3),  BATs_numbers_MCF7(1,3)} ... (BATs)
    { 'M_DBATs', '',  BATs_numbers_MCF7(1,5),  BATs_numbers_MCF7(1,5)} ... (BATs)
    { 'CAMA1', '',  1,1} ... (Tumor cells)
    { 'C_NBATs', '',  BATs_numbers_CAMA1(1,2),  BATs_numbers_CAMA1(1,2)} ... (BATs)
    { 'C_LBATs', '',  BATs_numbers_CAMA1(1,4),  BATs_numbers_CAMA1(1,4)} ... (BATs)
    { 'C_PBATs', '',  BATs_numbers_CAMA1(1,3),  BATs_numbers_CAMA1(1,3)} ... (BATs)
    { 'C_DBATs', '',  BATs_numbers_CAMA1(1,5),  BATs_numbers_CAMA1(1,5)} ... (BATs)
    { 'T47D', '',  1,1} ... (Tumor cells)
    { 'T_NBATs', '',  BATs_numbers_T47D(1,2),  BATs_numbers_T47D(1,2)} ... (BATs)
    { 'T_LBATs', '',  BATs_numbers_T47D(1,4),  BATs_numbers_T47D(1,4)} ... (BATs)
    { 'T_PBATs', '',  BATs_numbers_T47D(1,3),  BATs_numbers_T47D(1,3)} ... (BATs)
    { 'T_DBATs', '',  BATs_numbers_T47D(1,5),  BATs_numbers_T47D(1,5)} ... (BATs)
};

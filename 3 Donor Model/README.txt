...
BATs_numbers_D.xlsx: Excel file containing the BAT counts for each experiment binned by receptor expression.

Ligandvariable_test.m: MATLAB file run after CaliPro conclusion to plot results.

MAR24_3Donor_tumor.xlsx: RTCA data detailing tumor cell counts during coculture experiment.
...
TMinMax_2_donor1_norm.csv: Countains normalized conductivity values at relevant timepoints for the Donor 1 experiment.

TMinMax_2_donor2_norm.csv: Countains normalized conductivity values at relevant timepoints for the Donor 2 experiment.

TMinMax_2_donor3_norm.csv: Countains normalized conductivity values at relevant timepoints for the Donor 3 experiment.

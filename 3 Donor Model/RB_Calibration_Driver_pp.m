...
calibrationInput.terminate = 0.99;
...
calibrationInput.Tumor_cancerDS = csvread('TMinMax_2_donor1_norm.csv');
calibrationInput.Tumor_donorDS = csvread('TMinMax_2_donor1_norm.csv');

calibrationInput.passCriteriaInitial = 2;
calibrationInput.passCriteriaNonInitial = 1.5;
